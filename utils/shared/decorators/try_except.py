...
def try_except(exception: list=[Exception], 
    ...
    def decorator(func):
        ...
        return TryExcept.get_wrapper(async_=async_, 
                                        exception=exception, 
...
class TryExcept:
    ...
    def get_wrapper(async_, 
        ...
        if not instance.async_:
            return instance.sync_wrapper()
        else:
            return instance.async_wrapper()

    def _add_in_base_exception(self):
    ...
    def _get_exit_context(self, func: Callable|Coroutine, *args):
        """
    ...
    def _handle_retries(self, attempts, error_message, retry_message, func_name):
        break_loop = False
